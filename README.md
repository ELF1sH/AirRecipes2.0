...
**Single page [React](https://reactjs.org/) application**
...
Deploys project on Github Pages.

### `npm run predeploy`

Builds project before deployment. Necessary step required by Github Pages.
